...
if __name__ == '__main__':
    ...
    params = {'scale': torch.tensor([150.]), 'gamma': torch.Tensor([0.5]), 'lengthscale': torch.tensor([0.35])}
    ...
    # ------------------------------------------------LBPP-------------------------------------------------------------#
    lbpp_model = LBPP(X, N=32, a=torch.Tensor([0.0002]), b=torch.Tensor([0.0002]), m=2,
